...
%     FileTif=sprintf('E:\\BrendanTut\\Trial_1_9_29_2917\\testout\\merge_f%04d.tif',i);
...
%     c=imfuse(a,b);
%     d=rgb2gray(c);
%     imwrite(d, sprintf('E:\\BrendanTut\\Trial_1_9_29_2917\\mergenuclear\\nuclear_f%04d.tif',i), 'tif');
% end
%% Section
mkdir('masks');
...
function h5tobinmaskFILE(filename,pos,label,tpt)
    ...
    fn1 = sprintf('mask_f%04d',pos);
    imwrite(ccshedcc, ['E:\BrendanTut\Trial_1_9_29_2917\masks\',fn1,'.tif'],'Compression','none');
